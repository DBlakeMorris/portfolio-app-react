      ...
      <div className="page-inner">
        ...
        <div className="about-stats-grid" style={{ borderTop: `1px solid ${C.border}`, paddingTop: '2.5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '2rem' }}>
          {[
            ...
            { target: 14, prefix: '', suffix: '+', label: 'Speaking Events' },
...
const speakingEvents = [
  ...
  { event: 'Ville de Lausanne — Urban Intelligence Initiative 2026', topic: "Wiring the City Brain", location: 'Lausanne, Switzerland' },
...
const testimonials = [
  { quote: "Daniel played a key role in fine-tuning various models to align their behavior with Reddit's unique data. His work consistently reflected a high level of attention to detail, and he demonstrated strong problem-solving skills by regularly proposing effective alternative solutions when challenges arose. Daniel took ownership of his responsibilities with impressive independence.", name: 'Dr Jose Luis Martinez', title: 'Director of Machine Learning, Reddit', linkedin: 'https://www.linkedin.com/in/jlmartinezfernandez/' },
  { quote: "The RAG system Daniel built was a pivotal proof-of-concept. It successfully demonstrated how a context-aware, document-grounded AI assistant should work in practice — both in terms of architecture and user interaction. This helped steer us toward a containerised, scalable design we eventually adopted. The tool — now evolved — is currently available via the Azure Marketplace as a 1-touch deployment solution.", name: 'Andrew Cairns', title: 'Head of Data Architecture, ISx4', linkedin: 'https://www.linkedin.com/in/andrew-cairns-b7a32b77/' },
]
